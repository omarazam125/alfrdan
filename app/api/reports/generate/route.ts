...
export async function POST(request: NextRequest) {
  try {
    ...
    const analysisPrompt = `⚠️ مهم جداً: يجب أن تكون جميع المخرجات باللغة العربية فقط ⚠️
...
1. **استخراج معلومات العميل**:
   ...
   - حدد مزاج العميل: سعيد، راضٍ، محايد، محبط، أو غاضب
...
أجب بتنسيق JSON بهذا الهيكل (جميع القيم النصية يجب أن تكون بالعربية):
{
  "customerName": "string (بالعربية)",
  "customerMood": "سعيد|راضٍ|محايد|محبط|غاضب",
